...
def init_db():
    ...
    db.incidents.create_index([("website_id", ASCENDING), ("approval_status", ASCENDING)])
    db.incidents.create_index([("website_id", ASCENDING), ("classification.predicted_class", ASCENDING)])
    db.incidents.create_index([("website_id", ASCENDING), ("classification.attack.severity", ASCENDING)])
